...
const AfteLogin = () => {
  ...
  if(!isLoggedIn){
    return <BeforeLogin onLogin={handleLogin}/>
  }
  ...
  return (
    <div className="  flex items-center justify-between m-auto gap-4">
      ...
      <div className="flex items-center justify-between border rounded-md border-gray-500 gap-2">
        <div >
          <svg
            width="24"
            height="24"
        ...
        <select className="border-none bg-inherit appearance: none font-sans" value={selectedOption} onChange={handleSelectChange}>
